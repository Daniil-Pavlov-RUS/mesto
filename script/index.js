...
//Popup
const formEdit = popupRedactProfiles.querySelector('.popup__form'); //formEdit
const cardFormAdd = popupAddElement.querySelector('.popup__form'); // cardFormAdd

// Заполнение формы карточек
const fieldCardName = document.querySelector('.popup__row_data_name');
const fieldCardProfession = document.querySelector('.popup__row_data_profession');
...
// Заполнение карточки
cardFormAdd.addEventListener('submit', (evt) => { // ssasas
    evt.preventDefault();
...
//Карточки
const elementList = document.querySelector('.elements'); //elementContainer
