...
const popupAddSubmitButton = popupRedactProfiles.querySelector('.popup__button_submit');
...
function closePopupForm(popup) {
    ...
    document.removeEventListener('keydown', closePopupFormEscape);
};
...
popupRedactSubmitBtnForm.addEventListener('submit', (event) => {
