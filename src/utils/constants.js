...
export const popupProfileProfessionSelector = '#profession-input';

export const popupCardSelector = '.popup_add_cards';
...
export const formSelectors = {
    ...
    inputErrorUnderlineClass: 'popup__button_type_error',
    activeErrorClass: 'popup__input-error_active',
    inactiveSubmitButtonClass: 'popup__button_submit-inactive',
    popupSubmitButtonSelector: '.popup__button_submit'
};